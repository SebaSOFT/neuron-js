...
- [Generic decision runtime](generic-decision-runtime/) — evaluate a caller-defined context and outcome through the pure decision runtime without a vertical dependency.
